...
class BowlerAverageWidget extends StatelessWidget {
  const BowlerAverageWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MainScaffold(
      title: "Bowler Average Calculator",
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (Runs.text.isEmpty || Wkts.text.isEmpty) {
                      showDialog(
                        context: context,
                    ...
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        title: Text("Average"),
                        content: Text(
                          "Your Average is ${avg.toStringAsFixed(2)}",
